<template>
  <div class="bg-indigo9">
    <div
      class="max-w-screen-lg py-10 px-4 sm:px-6 text-white sm:flex justify-between mx-auto"
    >
      <div class="p-5 sm:w-2/12 border-r">
        <div class="text-sm uppercase text-white font-bold">Menu</div>
        <ul>
          <li class="my-2">
            <a  href="#">Home</a>
          </li>
      ...
      <div class="p-5 sm:w-7/12 border-r text-center">
        <h3 class="font-bold text-xl  mb-4">Componentity</h3>
      ...
      <div class="p-5 sm:w-3/12">
        ...
        <ul>
          <li class="my-2">
            <a  href="#"
              >XXX XXXX, Floor 1 Philippines, PH</a
            >
          </li>
          <li class="my-2">
    ...
    <div
      class="flex py-5 m-auto text-white text-sm flex-col items-center border-t max-w-screen-xl"
    >
      <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
        <a href="#" class="w-6 mx-1">
          <svg
            class="fill-current cursor-pointer text-white "
            width="100%"
            height="100%"
            viewBox="0 0 24 24"
            version="1.1"
